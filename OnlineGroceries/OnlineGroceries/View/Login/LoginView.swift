    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack{
                ...
                LineTextField(txt: $loginVM.txtEmail, title: "Email", placeholder: "Enter your Email Address",keyboardType: .emailAddress).padding(.bottom, .screenWidth * 0.07).autocapitalization(.none)
                ...
                Button{
                    ...
                    RoundButton(title: "Log In"){
                        Task{
                            try await authVM.signIn(withEmail: loginVM.txtEmail , password: loginVM.txtPassword)
                        }
...
extension LoginView: AuthenticationFormProtocol{
    var formIsValid: Bool{
        return !loginVM.txtEmail.isEmpty && loginVM.txtEmail.contains("@") && !loginVM.txtPassword.isEmpty
    }
}
